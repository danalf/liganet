...
/**
 * AppBundle\Entity\Spieler
 *
 * @ORM\Table(name="ln_spieler")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\SpielerRepository")
 */
class Spieler {
     ...
     * Set veraendertvon
     *
     * @param AppBundle\Entity\Spieler $veraendertvon
     * @return Spieler
     */
    public function setVeraendertvon(\AppBundle\Entity\Spieler $veraendertvon = null)
    {
     ...
     * Set anrede
     *
     * @param AppBundle\Entity\Anrede $anrede
     * @return Spieler
     */
    public function setAnrede(\AppBundle\Entity\Anrede $anrede = null)
    {
        $this->anrede = $anrede;
     ...
     * Get anrede
     *
     * @return AppBundle\Entity\Anrede 
     */
     ...
     * Add staffelleiter
     *
     * @param \AppBundle\Entity\Liga $staffelleiter
     * @return Spieler
     */
    public function addStaffelleiter(\AppBundle\Entity\Liga $staffelleiter)
    {
     ...
     * @param \AppBundle\Entity\Liga $staffelleiter
     */
    public function removeStaffelleiter(\AppBundle\Entity\Liga $staffelleiter)
    {
     ...
     * Add mannschaften
     *
     * @param \AppBundle\Entity\MannschaftSpieler $mannschaften
     * @return Spieler
     */
    public function addMannschaften(\AppBundle\Entity\MannschaftSpieler $mannschaften)
    {
     ...
     * @param \AppBundle\Entity\MannschaftSpieler $mannschaften
     */
    public function removeMannschaften(\AppBundle\Entity\MannschaftSpieler $mannschaften)
    {
     ...
     *
     * @param \AppBundle\Entity\Mannschaft $captainForMannschaften
     * @return Spieler
     */
    public function addCaptainForMannschaften(\AppBundle\Entity\Mannschaft $captainForMannschaften)
    {
     ...
     * @param \AppBundle\Entity\Mannschaft $captainForMannschaften
     */
    public function removeCaptainForMannschaften(\AppBundle\Entity\Mannschaft $captainForMannschaften)
    {
     ...
     * Add spieler1_1
     *
     * @param \AppBundle\Entity\Ergebnis $spieler11
     * @return Spieler
     */
    public function addSpieler11(\AppBundle\Entity\Ergebnis $spieler11)
    {
     ...
     * @param \AppBundle\Entity\Ergebnis $spieler11
     */
    public function removeSpieler11(\AppBundle\Entity\Ergebnis $spieler11)
    {
     ...
     * Add spieler1_2
     *
     * @param \AppBundle\Entity\Ergebnis $spieler12
     * @return Spieler
     */
    public function addSpieler12(\AppBundle\Entity\Ergebnis $spieler12)
    {
     ...
     * @param \AppBundle\Entity\Ergebnis $spieler12
     */
    public function removeSpieler12(\AppBundle\Entity\Ergebnis $spieler12)
    {
     ...
     * Add spieler1_3
     *
     * @param \AppBundle\Entity\Ergebnis $spieler13
     * @return Spieler
     */
    public function addSpieler13(\AppBundle\Entity\Ergebnis $spieler13)
    {
     ...
     * @param \AppBundle\Entity\Ergebnis $spieler13
     */
    public function removeSpieler13(\AppBundle\Entity\Ergebnis $spieler13)
    {
     ...
     * Add spieler2_1
     *
     * @param \AppBundle\Entity\Ergebnis $spieler21
     * @return Spieler
     */
    public function addSpieler21(\AppBundle\Entity\Ergebnis $spieler21)
    {
     ...
     * @param \AppBundle\Entity\Ergebnis $spieler21
     */
    public function removeSpieler21(\AppBundle\Entity\Ergebnis $spieler21)
    {
     ...
     * Add spieler2_2
     *
     * @param \AppBundle\Entity\Ergebnis $spieler22
     * @return Spieler
     */
    public function addSpieler22(\AppBundle\Entity\Ergebnis $spieler22)
    {
     ...
     * @param \AppBundle\Entity\Ergebnis $spieler22
     */
    public function removeSpieler22(\AppBundle\Entity\Ergebnis $spieler22)
    {
     ...
     * Add spieler2_3
     *
     * @param \AppBundle\Entity\Ergebnis $spieler23
     * @return Spieler
     */
    public function addSpieler23(\AppBundle\Entity\Ergebnis $spieler23)
    {
     ...
     * @param \AppBundle\Entity\Ergebnis $spieler23
     */
    public function removeSpieler23(\AppBundle\Entity\Ergebnis $spieler23)
    {
     ...
     * Add ersatz1
     *
     * @param \AppBundle\Entity\Ergebnis $ersatz1
     * @return Spieler
     */
    public function addErsatz1(\AppBundle\Entity\Ergebnis $ersatz1)
    {
     ...
     * @param \AppBundle\Entity\Ergebnis $ersatz1
     */
    public function removeErsatz1(\AppBundle\Entity\Ergebnis $ersatz1)
    {
     ...
     * Add ersatzFuer1
     *
     * @param \AppBundle\Entity\Ergebnis $ersatzFuer1
     * @return Spieler
     */
    public function addErsatzFuer1(\AppBundle\Entity\Ergebnis $ersatzFuer1)
    {
     ...
     * @param \AppBundle\Entity\Ergebnis $ersatzFuer1
     */
    public function removeErsatzFuer1(\AppBundle\Entity\Ergebnis $ersatzFuer1)
    {
     ...
     * Add ersatz2
     *
     * @param \AppBundle\Entity\Ergebnis $ersatz2
     * @return Spieler
     */
    public function addErsatz2(\AppBundle\Entity\Ergebnis $ersatz2)
    {
     ...
     * @param \AppBundle\Entity\Ergebnis $ersatz2
     */
    public function removeErsatz2(\AppBundle\Entity\Ergebnis $ersatz2)
    {
     ...
     * Add ersatzFuer2
     *
     * @param \AppBundle\Entity\Ergebnis $ersatzFuer2
     * @return Spieler
     */
    public function addErsatzFuer2(\AppBundle\Entity\Ergebnis $ersatzFuer2)
    {
     ...
     * @param \AppBundle\Entity\Ergebnis $ersatzFuer2
     */
    public function removeErsatzFuer2(\AppBundle\Entity\Ergebnis $ersatzFuer2)
    {
     ...
     * Add vereinsleiter
     *
     * @param \AppBundle\Entity\Verein $vereinsleiter
     * @return Spieler
     */
    public function addVereinsleiter(\AppBundle\Entity\Verein $vereinsleiter)
    {
     ...
     * @param \AppBundle\Entity\Verein $vereinsleiter
     */
    public function removeVereinsleiter(\AppBundle\Entity\Verein $vereinsleiter)
    {
     ...
     * Add regionsleiter
     *
     * @param \AppBundle\Entity\Region $regionsleiter
     * @return Spieler
     */
    public function addRegionsleiter(\AppBundle\Entity\Region $regionsleiter)
    {
     ...
     * @param \AppBundle\Entity\Region $regionsleiter
     */
    public function removeRegionsleiter(\AppBundle\Entity\Region $regionsleiter)
    {
